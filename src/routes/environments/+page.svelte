...
<div class="space-y-4">
	<div class="shrink-0 flex flex-wrap justify-between items-center gap-3 min-h-8">
		<PageHeader icon={Globe} title="环境">
			<Badge variant="secondary" class="text-xs">{environments.length} 个环境</Badge>
		</PageHeader>
	...
	<Dialog.Content class="max-w-md">
		...
		<div class="space-y-4">
			...
			<div class="space-y-2 pb-3 border-b">
				<Label for="quick-url">快速 URL（可选）</Label>
				<div class="flex gap-2">
					<Input
						id="quick-url"
						bind:value={quickUrl}
...
<Dialog.Root bind:open={showEditModal}>
	<Dialog.Content class="max-w-md">
		...
		<div class="space-y-4">
			...
			<!-- Quick URL parser -->
			<div class="space-y-2 pb-3 border-b">
				<Label for="edit-quick-url">快速 URL（可选）</Label>
				<div class="flex gap-2">
					<Input
						id="edit-quick-url"
						bind:value={quickUrl}
